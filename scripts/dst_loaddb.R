...
ncu_nuts_id <- readRDS('M:/My Documents/6 DST final/Data/R-inputs/ncu_nuts_3035.rds')
...
d1 <- as.data.table(readxl::read_xlsx('M:/My Documents/6 DST final/Data/R-inputs/NCU data crop area.xlsx',skip=1))
...
# crop naming
d1.crop <- as.data.table(readxl::read_xls('M:/My Documents/6 DST final/Data/R-inputs/CAPRI_CROP_DEF.xls'))
...
d2 <- fread('M:/My Documents/6 DST final/Data/R-inputs/ncu_covariates.csv')
...
nuts_name_code <- as.data.table(read_xls('M:/My Documents/6 DST final/Data/R-inputs/eurostat_codes.xls',range = 'A1:A320'))
# rename column
...
# **********************************
# --------
d2.arable <- as.data.table(read_xlsx('M:/My Documents/6 DST final/Data/R-inputs/Eurostat_till-cov-rot.xlsx',sheet='Arable land area',skip=4, range='A5:G335'))
# change column names
...
d2.rot <- as.data.table(read_xlsx('M:/My Documents/6 DST final/Data/R-inputs/Eurostat_till-cov-rot.xlsx',sheet='Crop rotation',skip=4))
# change column names
...
d2.cover <- as.data.table(read_xlsx('M:/My Documents/6 DST final/Data/R-inputs/Eurostat_till-cov-rot.xlsx',sheet='Soil cover and residues',skip=4))
# change column names
...
# read tillage
d2.tillage <- as.data.table(read_xlsx('M:/My Documents/6 DST final/Data/R-inputs/Eurostat_till-cov-rot.xlsx',sheet='Tillage Practices',skip=4))
# change column names
